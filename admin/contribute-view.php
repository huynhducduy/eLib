		...
		<div class="page-content">
			<div class="page-head">
				<div class="page-title">
					<h1>Đóng góp<small> Xem đóng góp</small></h1>
				</div>
			</div>
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="contribute-list.php">Đóng góp sach</a>
					<i class="fa fa-circle"></i>
				</li>
				<li>
					<a href="#">Xem</a>
			...
			<?php
			$sql="SELECT * FROM `contribute` WHERE `id`='".$_GET['id']."'";
			...
			if (@mysql_num_rows($query) > 0)
			{
				...
				switch ($row['status']) {
					...
					case '1': $status='default">Chưa nhận'; break;
					case '2': $status='success">Đã nhận'; break;
					case '3': $status='danger">Không nhận'; break;
				}
			?>
			<div class="row">
				<div class="col-md-12">
 						...
 						<div class="portlet light">
							<div class="portlet-title">
								...
								<div class="actions btn-set">
									<button type='button' class="btn btn-default btn-circle"><a href='contribute-list.php'><i class="fa fa-angle-left"></i> Quay lại</a></button>
									<?php
									if ($row['status'] == '0')
									{
									?>
									<button type="button" onclick="acceptContribute(<?=$row['id']?>)" class="btn green-haze btn-circle"><i class="fa fa-check"></i> Xác nhận</button>
									<button type="button" onclick="dismissContribute(<?=$row['id']?>)" class="btn red btn-circle"><i class="fa fa-remove"></i> Không nhận</button>
									<?php
									}
									if ($row['status'] == '1')
									{
									?>
									<button type="button" onclick="contributed(<?=$row['id']?>)" class="btn purple btn-circle"><i class="fa fa-check"></i> Đã nhận</button>
									<?php
									}
									?>
								</div>
								...
								<div class="tabbable">
									<div class="tab-content no-space">
										<div class="form-body">
											...
											<div class="form-group">
												<label class="col-md-2 control-label">Người đóng góp: </label>
												<div class="col-md-10">
			...
			<?php
				...
				echo '<div class="alert alert-danger alert-dismissable"><span class="alert-content">đóng góp này không có thật</span></div>';
			}
			?>
		</div>
	</div>
