...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
$sql="SELECT * FROM `request` WHERE `userid`='".$_REQUEST['userid']."'";
...
switch ($_REQUEST['order']['0']['column']) {
  ...
  case '4': $sql.=" ORDER BY `status` ".$_REQUEST['order']['0']['dir']; break;
...
while ($row2=@mysql_fetch_assoc($query2))
{
    ...
    ti_me($row2['time']),
    $status,
    '<a href="request-edit.php?id='.$row2['id'].'" class="btn btn-xs default btn-editable"><i class="fa fa-pencil"></i> Chi tiết</a>',
  );
}
$records["draw"] = $sEcho;
