		...
		<div class="page-content">
			<div class="page-head">
				<div class="page-title">
					<h1>Danh sách nhận xét <small>Liệt kê nhận xét trên thư viện</small></h1>
				</div>
			</div>
				...
				<div class="col-md-12">
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa icon-cursor font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Danh sách nhận xét</span>
								<span class="caption-helper">Quản lí nhận xét</span>
							</div>
						</div>
