		...
		<div class="page-content">
			<div class="page-head">
				<div class="page-title">
					<h1>Xem bình luận<small> Xem và sửa bình luận</small></h1>
				</div>
			</div>
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="comment-list.php">Bình luận</a>
					<i class="fa fa-circle"></i>
				</li>
				<li>
					<a href="#">Xem/sửa</a>
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal form-row-seperated" id='prodata' onsubmit='return editComment();'>
 						...
 						<div class="portlet light">
							<div class="portlet-title">
								...
								<div class="actions btn-set">
									<button type='button' class="btn btn-default btn-circle"><a href='comment-list.php'><i class="fa fa-angle-left"></i> Quay lại</a></button>
									<button type='button' class="btn red btn-circle"><i class="fa fa-remove" onclick='delComment()'></i> Xóa</button>
			...
			<?php
				...
				echo '<div class="alert alert-danger alert-dismissable"><span class="alert-content">Bình luận này không có thật</span></div>';
			}
			?>
		</div>
	</div>
