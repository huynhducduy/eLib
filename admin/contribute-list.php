		...
		<div class="page-content">
			<div class="page-head">
				<div class="page-title">
					<h1>Danh sách đóng góp sách <small>Liệt kê các đóng góp sách trên thư viện</small></h1>
				</div>
			</div>
				...
				<div class="col-md-12">
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa icon-badge font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Danh sách đóng góp</span>
								<span class="caption-helper">Quản lí đóng góp sách</span>
							</div>
						</div>
						<div class="portlet-body">
							<div class="table-container">
								...
								<table class="table table-striped table-bordered table-hover" id="datatable_contributes">
								<thead>
								...
								<tr role="row" class="filter">
									...
									<td>
										<input type="text" class="form-control form-filter input-sm" name="contribute_user">
									</td>
									<td>
									...
									<td>
										<select name="contribute_status" class="form-control form-filter input-sm">
