<?php
class contributed_controller
{
	var $d = 12;
	var $range = 7;
	var $str_uri = '/sach-duoc-dong-gop';
	var $str_uri_p = '/sach-duoc-dong-gop/trang-';
	var $page;
	var $p;
	var $start;
	var $start2;
	...
	function handle_page()
	{
		...
		$this->page=ceil($contributed_model->record/$this->d); 
	}
	...
	function handle_start_end()
	{
		...
		$this->end=($this->p<$this->page)?$this->p*$this->d:$contributed_model->record;
	}
