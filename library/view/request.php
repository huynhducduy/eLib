...
class request_view
{
	function show_breadcrumb()
	{
		echo "<ul class='breadcrumb'>
            ...
            <li class='active'>Yêu cầu sách</li>
        </ul>";
	}
	...
	{
		echo "<form class='form-horizontal form-without-legend' role='form' method='POST' action='' id='request' onsubmit='return request()' enctype='multipart/form-data'>
	...
	{
		echo "<br/>
		<div class='alert alert-danger'>Bạn phải đăng nhập để yêu cầu sách!</div>";
	}
	...
	function config()
	{
		...
		$header_view->title='Yêu cầu sách';
		$header_view->description='Yêu cầu sách';
		$header_view->keyword='yeu cau sach';
		$header_view->pagelv2="
