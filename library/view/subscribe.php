...
class subscribe_view
{
	function show_breadcrumb()
	{
		echo "<ul class='breadcrumb'>
            ...
            <li class='active'>Đăng ký theo dõi</li>
        </ul>";
	}
	...
	{
		echo "<form class='form-horizontal form-without-legend' role='form' method='POST' action='' id='subscribe' onsubmit='return subscribe()'>                    
          <div class='form-group' id='emaildiv'>
            <label for='email' class='col-lg-4 control-label'>Email</label>
            <div class='col-lg-8'>
              <div class='input-icon right'>
		    <i class='fa fa-info-circle tooltips' data-original-title='Địa chỉ email đã dùng để đăng ký' data-container='body' id='erremail'></i>
              <input type='text' class='form-control' id='email' value='".$_GET['email']."'>
            </div>
		  </div>
          </div>
		<div class='row'>
            <div class='col-lg-8 col-md-offset-4 padding-left-0'>
              <a href='../../huy-theo-doi'>Hủy đăng ký theo dõi?</a>
            </div>
          </div>
		<br/>
          <div class='row'>
            <div class='col-lg-8 col-md-offset-4 padding-left-0 padding-top-5'>
			<button type='submit' class='btn btn-primary'><i class='fa fa fa-circle'></i>&nbsp;&nbsp;Theo dõi</button>
            </div>
          </div>
		<br/>
	...
	{
		global $header_view;
		$header_view->title='Đăng ký theo dõi';
		$header_view->description='Đăng ký theo dõi';
		$header_view->keyword='dang ky theo doi';
